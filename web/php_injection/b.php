  ...
  <body>
    <h1>Hello, world!</h1>
        ...
        <div class="input-group">
          ...
          <input type="text" name='user' class="form-control col-sm-8" require maxlength=10 placeholder="user" aria-label="username textarea">
        </div>
        <div class="input-group">
          <span class="input-group-text">password</span>
          <input type="password" name='password' require class="form-control" maxlength=10 placeholder="pass" aria-label="password textarea">
        </div>
